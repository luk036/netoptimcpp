...
breathe_projects = {"netoptimcpp": "./doxyoutput/xml"}
breathe_default_project = "netoptimcpp"
...
htmlhelp_basename = 'netoptimcppdoc'
...
latex_documents = [
  (master_doc, 'netoptimcpp.tex', u'netoptimcpp Documentation',
...
man_pages = [
    (master_doc, 'netoptimcpp', u'netoptimcpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'netoptimcpp', u'netoptimcpp Documentation',
   author, 'netoptimcpp', 'One line description of project.',
   'Miscellaneous'),
]
